...
// func (adapter outputAdapter) BroadcastMessageToSubscriber func() error {}
type ForBroadcastMessageToDestination func(ctx context.Context, data <-chan []byte) chan struct{}
