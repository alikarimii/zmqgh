...
func (x *ZeroMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ZeroMessage) ProtoMessage() {}

func (x *ZeroMessage) ProtoReflect() protoreflect.Message {
	mi := &file_broker_proto_msgTypes[0]
...
// Deprecated: Use ZeroMessage.ProtoReflect.Descriptor instead.
func (*ZeroMessage) Descriptor() ([]byte, []int) {
	return file_broker_proto_rawDescGZIP(), []int{0}
}

func (x *ZeroMessage) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ZeroMessage) GetAge() uint32 {
	if x != nil {
		return x.Age
	}
	return 0
...
var file_broker_proto_rawDesc = []byte{
	,
}
...
var file_broker_proto_goTypes = []interface{}{
	(*ZeroMessage)(nil), // 0: zerobroker.ZeroMessage
}
